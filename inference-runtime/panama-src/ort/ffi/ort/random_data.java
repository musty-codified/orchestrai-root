...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        onnxruntime_c_api_h.C_POINTER.withName("fptr"),
        onnxruntime_c_api_h.C_POINTER.withName("rptr"),
        onnxruntime_c_api_h.C_POINTER.withName("state"),
        onnxruntime_c_api_h.C_INT.withName("rand_type"),
        onnxruntime_c_api_h.C_INT.withName("rand_deg"),
        onnxruntime_c_api_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        onnxruntime_c_api_h.C_POINTER.withName("end_ptr")
