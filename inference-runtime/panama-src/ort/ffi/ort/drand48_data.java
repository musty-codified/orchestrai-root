...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, onnxruntime_c_api_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, onnxruntime_c_api_h.C_SHORT).withName("__old_x"),
        onnxruntime_c_api_h.C_SHORT.withName("__c"),
        onnxruntime_c_api_h.C_SHORT.withName("__init"),
        onnxruntime_c_api_h.C_LONG_LONG.withName("__a")
