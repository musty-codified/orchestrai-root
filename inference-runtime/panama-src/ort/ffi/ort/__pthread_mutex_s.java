...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        onnxruntime_c_api_h.C_INT.withName("__lock"),
        onnxruntime_c_api_h.C_INT.withName("__count"),
        onnxruntime_c_api_h.C_INT.withName("__owner"),
        onnxruntime_c_api_h.C_INT.withName("__nusers"),
        onnxruntime_c_api_h.C_INT.withName("__kind"),
        onnxruntime_c_api_h.C_SHORT.withName("__spins"),
        onnxruntime_c_api_h.C_SHORT.withName("__elision"),
