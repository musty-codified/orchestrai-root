 ...
 * }
 */
public class ReleaseEpApiFactoryFn {

    ReleaseEpApiFactoryFn() {
    ...
    private static final MethodHandle UP$MH = onnxruntime_c_api_h.upcallHandle(ReleaseEpApiFactoryFn.Function.class, "apply", $DESC);
