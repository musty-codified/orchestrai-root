...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, onnxruntime_c_api_h.C_POINTER).withName("__locales"),
        onnxruntime_c_api_h.C_POINTER.withName("__ctype_b"),
        onnxruntime_c_api_h.C_POINTER.withName("__ctype_tolower"),
        onnxruntime_c_api_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, onnxruntime_c_api_h.C_POINTER).withName("__names")
