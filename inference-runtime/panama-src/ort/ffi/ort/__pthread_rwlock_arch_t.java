...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        onnxruntime_c_api_h.C_INT.withName("__readers"),
        onnxruntime_c_api_h.C_INT.withName("__writers"),
        onnxruntime_c_api_h.C_INT.withName("__wrphase_futex"),
        onnxruntime_c_api_h.C_INT.withName("__writers_futex"),
        onnxruntime_c_api_h.C_INT.withName("__pad3"),
        onnxruntime_c_api_h.C_INT.withName("__pad4"),
        onnxruntime_c_api_h.C_INT.withName("__cur_writer"),
        onnxruntime_c_api_h.C_INT.withName("__shared"),
        onnxruntime_c_api_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, onnxruntime_c_api_h.C_CHAR).withName("__pad1"),
        onnxruntime_c_api_h.C_LONG.withName("__pad2"),
        onnxruntime_c_api_h.C_INT.withName("__flags"),
